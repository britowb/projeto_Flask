...
def conversa(id):
    ...
    return render_template('conversas.html', conversa=conversas, quem=user, logado=eu)
...
def inbox():
    ...
    return render_template('inbox.html', usuarios=usuarios)
...
def send():
    if request.method =='GET':
        ...
        return render_template('send_message.html', users=usuarios)
    else:
